...
function compileAttrs(attrs, options) {
  ...
  assert(attrs.every(function (attr) {
    return attr &&
      ...
      (typeof attr.mustEscape === 'boolean' || attr.mustEscape === undefined && typeof attr.escaped === 'boolean');
  ...
  attrs.forEach(function(attr){
    var key = attr.name;
    var val = attr.val;
    var mustEscape = attr.mustEscape !== undefined ? attr.mustEscape : attr.escaped;
